...
export const ONBOARDING_TASKS: OnboardingTask[] = [
  {
    ...
    description: 'Set up your first project to organize shifts and employees',
    category: 'setup',
    order: 1,
  },
  {
    id: 'create_team',
    title: 'Create a Team',
    description: 'Organize employees into teams for easier management',
    category: 'setup',
    order: 2,
  },
  {
  ...
  },
  {
    ...
    description: 'Bulk import employees from a spreadsheet',
    category: 'data',
    order: 4,
  },
  {
    ...
    description: 'Define reusable shift patterns with start/end times',
    category: 'setup',
    order: 5,
  },
  {
    ...
    description: 'Schedule an employee for a shift',
    category: 'data',
    order: 6,
  },
  {
    ...
    description: 'Check fatigue compliance for your workforce',
    category: 'advanced',
    order: 7,
  },
];
