                  ...
                  <Box sx={{ p: 2 }}>
                    ...
                    {shifts.length === 0 ? (
                      ...
                      <Box sx={{ overflowX: 'auto' }}>
                        ...
                        {/* Header */}
                        <Box sx={{ display: 'grid', gridTemplateColumns: '42px 38px 44px 78px 78px 44px 38px 38px 38px 38px 38px 48px 48px', gap: 0.5, px: 1, py: 1, bgcolor: 'grey.100', borderRadius: 1, mb: 1, minWidth: 650 }}>
                        ...
                        {NR_DAYS.map((dayName, index) => {
                          ...
                          return (
                            <Box
                              ...
                              sx={{
                                display: 'grid',
                                gridTemplateColumns: '42px 38px 44px 78px 78px 44px 38px 38px 38px 38px 38px 48px 48px',
                                gap: 0.5,
                                p: 1,
                                borderRadius: 1,
                                alignItems: 'center',
