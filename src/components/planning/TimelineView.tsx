                    ...
                    <div
                      ...
                      className={`border-l border-slate-200 p-1 min-h-[70px] transition-colors ${
                        !isPartOfPattern 
                          ? 'bg-slate-100/50' 
                          : isWeekend 
                            ? 'weekend-hatch hover:bg-blue-50' 
                            : 'hover:bg-blue-50'
                      }`}
                    ...
                    >
                      ...
                      {cellAssignments
                        ...
                        .map((assignment) => (
                          <div
                            key={assignment.id}
                            className={`text-[10px] px-1.5 py-1 mb-1 rounded flex items-center justify-between gap-1 group hover:opacity-90 transition-colors ${getTileStyle(assignment.violations)}`}
