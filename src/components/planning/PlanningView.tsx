...
import { ChevronLeft, Download, Upload } from '@/components/ui/Icons';
...
export function PlanningView({
  ...
  const handleCellDrop = async (e: React.DragEvent, shiftPatternId: string, date: string) => {
    e.preventDefault();
    e.stopPropagation();
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-slate-100">
        ...
        <div className="flex flex-wrap items-center gap-3 bg-white shadow-sm border border-slate-200 rounded-lg px-4 py-3">
          ...
          <div className="flex items-center gap-2 ml-4">
            ...
            <select
              ...
              className="border border-slate-300 rounded-md px-2 py-1.5 text-sm bg-white min-w-[200px]"
            >
      ...
      <div className="flex-1 min-h-0 overflow-auto px-4">
        {viewMode === 'timeline' && currentPeriod && (
          <TimelineView
            project={project}
            employees={employees}
            ...
            {filteredEmployees.map(employee => {
              ...
              return (
                <div
                  ...
                  title="Drag to assign to shift. Ctrl+click to select multiple."
                >
