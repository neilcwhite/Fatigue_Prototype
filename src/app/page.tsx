...
export default function Home() {
  ...
  return (
    <>
      ...
      {currentView === 'planning' && selectedProject && (
        <div className="min-h-screen bg-slate-900 text-white p-8">
          <button onClick={handleBackToDashboard} className="btn btn-secondary mb-4">
            ← Back to Dashboard
          </button>
          <h1 className="text-2xl font-bold mb-4">
            Planning View - {projects.find(p => p.id === selectedProject)?.name}
          </h1>
          <p className="text-slate-400">
            Planning view component coming soon. 
            This will include Timeline, Gantt, and Weekly views.
          </p>
        </div>
      )}
